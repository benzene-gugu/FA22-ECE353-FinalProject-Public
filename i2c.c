...
/**
 * Sets the address for the sub device.
 */
...
/**
 * Busy wait until the receive interrupt flag is set.  After it has been set, return the byte of data that was received.
 */
...
/**
 * Busy wait while the I2C bus is busy.
 */
...
/**
 * Clears the interrupts for the i2c interface
 */
